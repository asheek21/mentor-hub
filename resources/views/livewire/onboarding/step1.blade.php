            ...
            <div class="lg:col-span-2">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
                    ...
                    <div class="flex items-center space-x-6">
                        ...
                        <div>
                            <flux:input type="file" wire:model="profilePicture" label="Profile Picture"
                                accept="image/*"
                        ...
                        <div class="mt-2">
                            ...
                            <select wire:model.defer="form.years_of_experience"
                                ...
                                @foreach ($experienceLevels as $experienceLevel)
                                    <option value="{{ $experienceLevel->value }}">{{ $experienceLevel->label() }}
                                    </option>
                                @endforeach
                            </select>
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                                    @foreach (['javascript', 'react', 'node js', 'python', 'java', 'typescript'] as $programming)
                                        <label
                                            ...
                                            <input wire:model.defer="form.specialization.programming" type="checkbox"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" wire:model.defer="form.hourly_rate"
                                ...
                                <p class="text-sm text-gray-500 mt-1">
                                    Recommended range: <i class="fa fa-inr mx-[3px] text-[12px]"
                                        aria-hidden="true"></i>50-250 per hour
                                </p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Session Duration</label>
                                <select wire:model.defer="form.session_duration" wire:click.debounce="previewUpdates"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
