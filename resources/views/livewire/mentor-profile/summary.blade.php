<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
    <div class="text-center mb-6">
        <div class="text-4xl font-bold text-gray-900 mb-2">{{ rupeeFormatter($user->mentorProfile->hourly_rate) }}</div>
        <p class="text-gray-600">per {{ $user->mentorProfile->session_duration }}/min session</p>
    </div>
